...
const GOOGLE_REDIRECT_URI =
  'https://slyncy-c0f11.firebaseapp.com/__/auth/handler'
const GOOGLE_CLIENT_ID =
  '598493394141-i17q0hqrhg8ujnjgqic0gg7d4g5gimd1.apps.googleusercontent.com'
const GOOGLE_CLIENT_SECRET = 'WxwdiwIeMP2BZbdhy0CWv2sH'
...
export async function fetchAccessTokens(code) {
  ...
  const response = await axios.post(GOOGLE_TOKEN_URL, queryParams, {
    headers: {
